...
public:
    static std::tuple<int, Type> GenerateBlockasmFromExpression(Token expression, int nextAllocatedLocation, const std::vector<Variable> &vars, std::stringstream &blockasm, Linker &l);
};
